...
Requirement coverage: `AUTH-01,04,07,09,12,13,15,16,17,20,39,40,43` (V1-Core),
`AUTH-02,03,06,08,10,11,14,18,19,21,22,27,28,29,30,31,32,33,34,35,37,38,42` (V1.1/V2),
`AUTH-24,25,26` (V3).
