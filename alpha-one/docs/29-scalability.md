...
| Tick rate (sustained) | 20/s | 100/s | 100/s (the V3 is the breadth, not the tick-rate, the 00 §5) |
...
| **Redis memory** (the session, the deny-set, the SSE, the rate-limit) | the ~4 GB (the 01 §4.3's SSE + the 02 §3.5's hot-set, the 06 §3.4's measured) | the 8 GB | the 8 GB (the Redis doesn't scale with the tenant, the 01 §4.3's relay is the horizontal, the §3) |
| **The 08's poll budget** (the MetaApi's, the 08 §3.2) | the 10k accounts × the stagger (the 60-s window, the 08 §3.2, the ~167 req/s to the MetaApi, the provider's limit, the 08 §1) | the 20k-class (the V3's 10k concurrent + the copy's order budget, the 27 Part B §11, the 2nd bridge-instance (the §3, the 08 §11's horizontal)) | the same model (the 2-bridge) |
...
| **OPS (06)** | The infra (the single-box, the 06 §1), the DR (the 06 §3.2, the RPO/RTO), the observability (the 06 §3.4) | The single-AX42 (the 06 §1), the WAL-rsync (the 06 §3.2), the Grafana (the 01 §2) | The 2-box (the §3, the PLT-02 (the 27 Part C.1)), the multi-region (the PLT-01 (the 27 Part C.1), the 28 §10's residency, the RTO-trigger (the 06 §3.2's 2× miss)), the Loki/OTel (the V2, the 01 §2's "consider", the 06 §3.4's upgrade) |
...
|---|---|---|---|
| **The PG down** (the primary) | The everything (the write + the read) — the platform-down (the 06 §3.3's P0) | The WAL (the 06 §3.2, the RPO ≤ 5-min), the replica (the V3, the §3.2), the 06 §3.3's runbook (the failover, the 06 §3.3, the RTO ≤ 2-h (the 00 §6, the 06 §3.2)), the no-Redis-dependency-on-the-trading (the 08 §3.2's PG-sync (the 01 ADR's posture, the 28 §2.3 #10)) | The 06 §3.3's failover (the 06 §3.3, the drill (the 06 §3.2's monthly, the 27 Part C.1's PLT-05's game-day (the 27 Part C.1 §2))), the CON-15 (the 21 §3.2, the P0, the 15-min (the 06 §3.3)), the status (the Uptime Kuma (the 06 §12), the DVP-07 (the 27 Part A §1, the V3)) |
...
| **The box down** (the infra) | The everything — the platform-down (the 06 §3.3's P0, the 00 §6's RTO ≤ 2-h (the 00 §6), the 06 §3.2) | The 06 §3.2's DR (the WAL (the 06 §3.2, the RPO ≤ 5-min (the 00 §6)), the 06 §3.2's restore (the 06 §3.2, the RTO ≤ 2-h (the 00 §6)), the 2nd-box (the V3, the §3.2, the RTO-improvement (the 06 §3.3's failover (the 06 §3.3), the minutes (the 27 Part C.1's PLT-01's class))), the multi-region (the V3-late, the §3.3, the PLT-01 (the 27 Part C.1), the RTO (the 06 §3.2, the minutes (the 27 Part C.1's PLT-01)), the Uptime Kuma (the 06 §12, the 21 §12, the detection (the 06 §3.3, the 1-min (the 06 §12's class, the 06 §3.3)), the status (the 06 §3.3, the 21 §3.2's CON-15 (the 21 §3.2), the tenant-notice (the 14's NOT, the 14 §3.4 (the 06 §3.3's comms (the 06 §3.3))), the manual-recovery (the 06 §3.2's runbook (the 06 §3.2), the 06 §3.3's P0 (the 06 §3.3, the 15-min (the 06 §3.3))) | The 06 §3.2's DR (the 06 §3.2, the monthly (the 06 §3.2, the 00 §6's binding), the 27 Part C.1's PLT-05's game-day (the 27 Part C.1 §2, the quarterly (the 27 Part C.1)), the CON-15 (the 21 §3.2, the P0, the 15-min (the 06 §3.3)), the 06 §3.3's runbook (the 06 §3.3, the §4's class) |
...
- **The restore-drill** (the 06 §3.2, the
  00 §6's binding, the monthly (the 06
  §3.2)): the RPO (the 06 §3.2, the ≤
  5-min (the 00 §6)), the RTO (the 06
  §3.2, the ≤ 2-h (the 00 §6)), the
