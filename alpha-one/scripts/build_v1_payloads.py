...
EVENTS = {
  ...
  "bridge.tick": {
    ...
    "source": "docs/08 §8 (canonical tick shape — D34, docs/51: positions array, margin/free_margin, leverage-as-string, deals_count, last_deal_ticket); money cents per docs/32 `account_snapshots`/`broker_accounts`",
    "payload": obj({
      "account_id": ULID,
